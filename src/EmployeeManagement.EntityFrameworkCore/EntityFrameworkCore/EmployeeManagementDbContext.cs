    ...
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(EmployeeManagementConsts.DbTablePrefix + "Departments", EmployeeManagementConsts.DbSchema);
        ...
        {
            b.ToTable(EmployeeManagementConsts.DbTablePrefix + "Employees", EmployeeManagementConsts.DbSchema);
            b.ConfigureByConvention(); //auto configure for the base class props
